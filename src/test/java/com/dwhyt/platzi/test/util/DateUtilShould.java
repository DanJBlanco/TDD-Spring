...
public class DateUtilShould {
    ...
    @Test
    public void return_true_year_is_divisible_by_4_but_not_by_100(){
    ...
    @Test
    public void return_false_when_is_not_divisible_by_4_and(){
    ...
    @Test
    public void testins(){
        double segundos=15230.6666;
        System.out.println("Div: " +  segundos/60.0 + " - " + Math.round( segundos/60.0 ));
        System.out.println(String.format("%1.0f min",((float)Math.round( segundos/60.0 )) ) );
    }
